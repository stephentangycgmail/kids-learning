(function () {
  ...
  function shouldAutostart() { const requested = requestedTopicId(); return new URLSearchParams(window.location.search).get("autostart") === "1" && topics.some((topic) => topic.id === requested); }
